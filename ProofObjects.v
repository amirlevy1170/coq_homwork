...
(** **** Exercise: 2 stars, standard, optional (eight_is_even)
...
Definition conj_fact : forall P Q R, P /\ Q -> Q /\ R -> P /\ R:=
   fun (P Q R: Prop) (PQ: P /\ Q) (QR: Q /\ R) =>
    conj (proj1 P Q PQ) (proj1 R Q (and_comm'_aux Q R QR)).
(** [] *)
...
(** **** Exercise: 1 star, standard, optional (p_implies_true)
...
(** **** Exercise: 1 star, standard, optional (ex_falso_quodlibet')
...
(** **** Exercise: 2 stars, standard, optional (eq_cons)
...
(** **** Exercise: 2 stars, standard, optional (equality__leibniz_equality_term)
...
(** **** Exercise: 3 stars, standard, optional (negations) *)
