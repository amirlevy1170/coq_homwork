...
(** **** Exercise: 4 stars, standard (min_max)

    In this exercise we prove a couple of facts about the [min] and
    [max] functions we saw in Recitation 1. It may be helpful to
    prove basic facts about these functions first. *)
...
Theorem min_leq_max : forall n m : nat,
  min n m <=? max n m = true.
Proof.
  (* FILL IN HERE *) Admitted.

Lemma min_mono_l : forall (n1 n2 m: nat),
  n1 <=? n2 = true -> min n1 m <=? min n2 m = true.
Proof.
  (* FILL IN HERE *) Admitted.

(** [] *)

(** **** Exercise: 6 stars, standard, optional (more_exercises)
...
Theorem andb_true_elim_snd : forall b c : bool,
